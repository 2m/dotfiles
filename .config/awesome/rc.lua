...
local function tag_control(keys)
...
tag_control({ "#10", "#11", "#12", "#13", "#14", "#15", "#16", "#17", "#18", })

-- Bind numpad numbers to tags.
tag_control({ "KP_End", "KP_Down", "KP_Next", "KP_Left", "KP_Begin", "KP_Right", "KP_Home", "KP_Up", "KP_Prior" })
...
globalkeys = shortcuts.add_to_global_keys(globalkeys)
clientkeys = shortcuts.add_to_client_keys(clientkeys)
